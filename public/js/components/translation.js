var translations = {
    en: {
        ...
        onb_p3: 'More updates are coming soon 🚀',
        onb_jin: 'Jump in !',
    ...
    fr: {
        ...
        con_des: 'Nous sommes toujours là pour vous aider',
        ...
        onb_p2: 'Le site est encore en développement, des bugs peuvent être présents',
        onb_p3: 'De nouvelles fonctionnalités arrivent sous peu 🚀',
        onb_jin: 'C\'est parti',
        pwr_title: 'Mot de passe oublié ?',
        pwr_sub: 'Nous sommes là pour vous',
        pwr_snd: 'Réinitialiser le mot de passe',
        usr_title: 'Compte utilisateur',
        usr_log: 'Déconnexion',
        usr_desc: 'Gérer vos infos et vot appareils',
